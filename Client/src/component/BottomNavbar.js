    ...
    return (
        <nav className="navbar fixed-bottom " style={{ backgroundColor: "#dcdada", height: "50px" }}>
            <div className="container-fluid justify-content-around">
                ...
                <Link to="/dashboard/refer_friends" className={location.pathname.includes('/refer_friends') ? "nav-link bottomnavbar-active " : "nav-link "}>
                ...
                <div className="nav-item dropdown">
                    <Link to="#" className={location.pathname.includes('/profile') ? "nav-link bottomnavbar-active dropdown-toggle" : "nav-link dropdown-toggle"} id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul className="dropdown-menu dropdown-menu-up" aria-labelledby="profileDropdown" style={{ maxWidth: "5px" }}>
                        <li>
                            <Link to="/dashboard/profile/about" className="nav-link"  aria-current="page">
                                <center>
                        ...
                        <li><Link to="/dashboard/notification" className= "nav-link">
                            <center>
                        ...
                        <li><Link className="dropdown-item" to="#" onClick={handleLogout}>
                            <center>
