        ...
        <div className="container d-flex  align-items-center">
            <div className="position-relative">
                <div className="card p-2 text-center">
                    <h3><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="bi bi-envelope-check" viewBox="0 0 16 16">
                    ...
                    <div className="mt-4">
                        <button className="btn btn-dark px-4 validate">Validate</button>
                    </div>
                </div>
            </div>
        </div>
