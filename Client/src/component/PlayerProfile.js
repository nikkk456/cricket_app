    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            await axios.post("http://localhost:8080/api/user/profile", value, {
                ...
                if (res.status === 201) {
                    console.log("This is the response from playerProfile", res.data[0]);
                        ...
                        userData? <>{
                            userData.instagram_links && userData.facebook_links ?
                                <div className='d-flex justify-content-center'>
                                    ...
                                    <div className='mx-2'><Link to={userData.facebook_links}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
