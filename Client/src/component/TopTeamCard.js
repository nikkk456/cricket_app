    ...
    return (
        <div className="card" style={{ width: "18rem", borderRadius:"15px" }}>
            ...
            <div className="card-body">
                ...
                <p className="card-text text-center">Rank {Team_Rank} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trophy gold-fill" viewBox="0 0 16 16">
