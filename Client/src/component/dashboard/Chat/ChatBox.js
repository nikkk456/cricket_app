    ...
    <div className='vh-100' style={{ width: "65%" }}>
      ...
      <div className='row' style={{ backgroundColor: "rgb(92 92 93)" }}>
        <div className='col-md-1' style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-emoji-smile" viewBox="0 0 16 16" style={{ fill: "white" }}>
        ...
        <div className='col-md-10 my-2'>
          <input type="text" className="form-control " id="message" style={{ borderRadius: "10px" }} aria-describedby="emailHelp" placeholder='Type a message' />
        </div>
        <div className='col-md-1' style={{ display: "flex", alignItems: "center" }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-send-fill" viewBox="0 0 16 16" style={{ fill: "white" }}>
