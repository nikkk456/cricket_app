...
const SideBar = ({ setSelectedFriend, setMessages }) => {
    ...
    var filteredFriends = friendslist.filter(friend =>
            ...
            <div className='container-fluid'>
                ...
                <Routes>
                    <Route path='friendschat' element={
                        <div className='row chat-list mt-3 no-scrollbar d-flex flex-column' style={{ minHeight: "30vh", maxHeight: "60vh", overflowY: "auto" }}>
                            {
