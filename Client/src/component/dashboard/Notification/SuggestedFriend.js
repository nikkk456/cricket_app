    ...
    return (
        <div className='row my-2 border-bottom' style={{ cursor: "pointer" }}>
            ...
            <div className='col-md-3 d-flex' style={{ justifyContent: "end", alignItems: "center" }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye mx-2" viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bs-title="View Profile" onClick={()=>{navigate('/playerprofile/1/about')}}>
