            ...
            <div className="d-flex flex-column flex-shrink-0  vh-100 position-fixed" style={{ width: "4.5rem", backgroundColor: "#dcdada" }}>
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    <li className="nav-item">
                        <a href="/dashboard/profile/about" className={location.pathname.includes('/profile')?"nav-link active":"nav-link link-body-emphasis"} aria-current="page">
                    ...
                    <li>
                        <a href="/dashboard/chat/friendschat" className={location.pathname.includes('/chat')?"nav-link active":"nav-link link-body-emphasis"}>
