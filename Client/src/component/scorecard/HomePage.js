                            ...
                            <div className='container'>
                                <div className='row mt-2'>
                                    <div className='col-md-6'>
                                        <h6>Team A</h6>
                                        <select className="form-select" aria-label="Default select example" name='preferred_playing_position' onChange={(e)=>{setTeamA(e.target.value)}}>
                                    ...
                                    <div className='col-md-6'>
                                        <h6>Team B</h6>
                                        <select className="form-select" aria-label="Default select example" name='preferred_playing_position' onChange={(e)=>{setTeamB(e.target.value)}}>
                                            <option value="">Select First Team</option>
                                            <option value="Bengal Tigers" >Bengal Tigers</option>
                                            <option value="UP Warriers">UP Warriers</option>
                                            <option value="Haryana Steelers">Haryana Steelers</option>
                                ...
                                <div className='row mt-2'>
                                    <div className='col-md-6'>
                                        <h6>No. Of Overs</h6>
                                        <input type="number" className="form-control" id="playerWeight" name='overs' placeholder='Number of overs' onChange={(e)=>{setOver(e.target.value)}}></input>
                                    </div>
                                    <div className='col-md-6'>
                                        <h6>
                                            Start Time
