...
const HomePage = () => {
    ...
    const handleTimeChange = (event) => {
        ...
        setChallenge({ ...challenge, startTime: convertTo12HourFormat(timeValue) })
    };
    ...
    const handleSubmit = () => {
        if(!challenge.teamA || !challenge.teamB || !challenge.overs || !challenge.startTime){
            ...
            navigate(`/scorecard/${challenge.teamA}/vs/${challenge.teamB}/${challenge.overs}/tossCoin`);
        }
    }
    ...
    const handleChange = (selectedOptions) => {
        ...
        setChallenge({...challenge, teamAPlayers:selectedOptions});
    };
    const handleChangeTeamB = (selectedOptions) => {
        setSelectedPlayers(selectedOptions);
        setChallenge({...challenge, teamBPlayers:selectedOptions});
    };
    return (
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                            ...
                            <div className='container'>
                                <div className='row mt-2'>
                                    <div className='col-md-6'>
                                        <h6>Team A</h6>
                                        <select className="form-select" aria-label="Default select example" name='preferred_playing_position' onChange={(e)=>{setChallenge({ ...challenge, teamA: e.target.value });}}>
                                            <option value="">Select First Team</option>
                                            <option value="Bengal Tigers" >Bengal Tigers</option>
                                            <option value="UP Warriers">UP Warriers</option>
                                            <option value="Haryana Steelers">Haryana Steelers</option>
                                            <option value="Goa Funkies">Goa Funkies</option>
                                        </select>
                                    </div>
                                    <div className='col-md-6'>
                                        <h6>Team B</h6>
                                        <select className="form-select" aria-label="Default select example" name='preferred_playing_position' onChange={(e)=>{setChallenge({ ...challenge, teamB: e.target.value })}}>
                                            <option value="">Select First Team</option>
                                            <option value="Bengal Tigers" >Bengal Tigers</option>
                                            <option value="UP Warriers">UP Warriers</option>
                                            <option value="Haryana Steelers">Haryana Steelers</option>
                                ...
                                <div className='row mt-2'>
                                    <div className='col-md-6'>
                                        <h6>No. Of Overs</h6>
                                        <input type="number" className="form-control" id="playerWeight" name='overs' placeholder='Number of overs' onChange={(e)=>{setChallenge({ ...challenge, overs: e.target.value })}}></input>
                                    </div>
                                    <div className='col-md-6'>
                                        <h6>
                                            Start Time
                        ...
                        <div className="modal-footer">
                            {betting && ( // Conditionally show for Betting Match only
                                <div className='d-flex align-items-center justify-content-end'>
                                    ...
                                    <div className="input-group" style={{ width: "30%" }}>
                                        <input type="number" className="form-control" placeholder="Coins" aria-label="Recipient's username" aria-describedby="basic-addon2" onChange={(e)=>{setChallenge({...challenge, ChallengeCoins:e.target.value})}} />
                            ...
                            <button type="button" className="btn btn-dark btn-sm" data-bs-dismiss="modal" aria-label="Close" onClick={handleSubmit}>Lets Toss!</button>
