...
const HandleBall = ({handleBallInput, handleWideOrNoBall,handleWicket }) => {
    return (
        <div className="score-update-buttons d-flex flex-wrap gap-3 my-3">
            <button className="btn btn-outline-primary rounded shadow-lg" onClick={() => handleBallInput(0)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-0-circle-fill" viewBox="0 0 16 16">
            ...
            <button className="btn btn-outline-success rounded shadow-lg" onClick={() => handleBallInput(4)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-4-circle-fill" viewBox="0 0 16 16">
            ...
            <button className="btn btn-outline-success rounded shadow-lg" onClick={() => handleBallInput(6)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-6-circle-fill" viewBox="0 0 16 16">
            ...
            <button className="btn btn-outline-warning rounded shadow-lg px-4  fs-5" onClick={() => handleWideOrNoBall(1)}>
                <i className="bi bi-exclamation-triangle"></i> Wide
            </button>
            <button className="btn btn-outline-warning rounded shadow-lg px-4  fs-5" onClick={() => handleWideOrNoBall(1)}>
                <i className="bi bi-exclamation-triangle"></i> No Ball
            </button>
            <button className="btn btn-outline-danger rounded shadow-lg px-4  fs-5" onClick={handleWicket}>
                <i className="bi bi-x-circle-fill"></i> Wicket
            </button>
        </div>
    )
}
