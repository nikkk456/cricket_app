    ...
    return (
        <>
            <div className="score-update-buttons d-flex flex-wrap gap-3 my-3">
                ...
                <button className="btn btn-outline-danger rounded shadow-lg px-4  fs-5" onClick={()=>handleWicket('C')}>
                    Caught
                </button>
                <button className="btn btn-outline-danger rounded shadow-lg px-4  fs-5" onClick={()=>handleWicket('R')}>
                    Run Out
                </button>
                <button className="btn btn-outline-danger rounded shadow-lg px-4  fs-5" onClick={()=>handleWicket('B')}>
                    Bowled
                </button>
            </div>
            <div className="score-update-buttons d-flex flex-wrap gap-3 my-3">
